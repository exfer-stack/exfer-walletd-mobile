...
const EN = {
  ...
  "mn.helpTitle": "About recovery phrases",
  "mn.helpOk": "Got it",
  "mn.help1": "To match the web wallet and the other Exfer apps, new addresses use the standard BIP39 scheme. Addresses created in earlier versions used the previous scheme.",
  "mn.help2": "The same words map to two different addresses — one per scheme. That's two ways to read the same phrase, not your phrase or address changing on its own. The words you wrote down never change.",
  "mn.help3": "When importing, pick the address that shows your balance — that's your wallet. If only one is funded, the app selects it for you.",
  "mn.help4": "If the phrase you export looks different from the one you imported, don't worry — nothing is lost. Re-importing that exported phrase recovers the very same address.",
...
const ZH: Record<MsgKey, string> = {
  ...
  "mn.helpTitle": "关于助记词类型",
  "mn.helpOk": "知道了",
  "mn.help1": "为了和网页钱包及其它 Exfer 客户端统一，新版地址采用标准 BIP39 助记词方案；早期版本创建的地址用的是旧版方案。",
  "mn.help2": "同一串词在两种方案下会算出两个不同地址——这是同一串助记词的两种「读法」，不是你的助记词或地址自己变了。你记下来的词永远不变。",
  "mn.help3": "导入时选「显示有余额」的那个就是你的钱包；只有一个有余额时，App 会自动帮你认出来。",
  "mn.help4": "如果你发现导出的助记词和导入时的那串不一样，也别担心——钱包没丢。用导出的这串（不一样的）助记词重新导入，一样能恢复到同一个地址。",
