...
const EN = {
  ...
  "home.depositBnbBody":
    "Only send BNB on the BNB Smart Chain (BSC) network. Other networks (Beacon Chain / opBNB) will lose the funds.",
  ...
  "swap.fundHint": "Only send BNB on the BNB Smart Chain (BSC) network. Other networks will lose the funds.",
...
const ZH: Record<MsgKey, string> = {
  ...
  "home.depositBnbBody":
    "只往这个地址充 BNB 智能链（BSC）的 BNB。用错网络（Beacon Chain / opBNB）会丢币。",
  ...
  "swap.fundHint": "只往这个地址充 BNB 智能链(BSC)的 BNB。用错网络会丢币。",
