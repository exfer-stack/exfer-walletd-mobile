...
const EN = {
  ...
  "mn.help3": "Most important: even if it looks different, re-importing the phrase shown here recovers the very same address and your coins.",
...
const ZH: Record<MsgKey, string> = {
  ...
  "mn.help3": "最重要的一点：就算看起来不一样，你拿这里显示的这串助记词再次导入，照样能恢复到同一个地址、拿回你的币。",
