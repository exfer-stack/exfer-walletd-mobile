...
const EN = {
  ...
  "imp.schemeTitle": "Phrase type",
  "imp.schemeHint": "The same words map to a different address per type. Pick the one whose address matches yours.",
...
const ZH: Record<MsgKey, string> = {
  ...
  "imp.schemeTitle": "助记词类型",
  "imp.schemeHint": "同样的词在不同类型下对应不同地址，请选地址与你一致的那个。",
