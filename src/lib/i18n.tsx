...
const EN = {
  ...
  "mn.helpTitle": "Why does it look different?",
  "mn.helpOk": "Got it",
  "mn.help1": "The phrase you wrote down never changes, and your address never changes on its own.",
  "mn.help2": "The phrase shown here can sometimes look different from the one you imported — that's just the wallet's upgraded phrase format, not an error.",
...
const ZH: Record<MsgKey, string> = {
  ...
  "mn.help2": "这里显示的助记词，有时会和你当初导入的那串看起来不一样——这只是钱包格式升级造成的，属于正常现象，不是出错。",
