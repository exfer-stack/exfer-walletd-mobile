...
const EN = {
  ...
  "swap.max": "Max",
  "swap.sellReceiveHint": "You'll receive BNB at your in-wallet BNB Smart Chain address. To cash out, withdraw that BNB to an exchange and sell it for your currency.",
  ...
  "swap.stepLocked": "Your funds locked",
  "swap.stepMatched": "Counterparty matched",
  "swap.stepSettling": "Settling & payout",
...
const ZH: Record<MsgKey, string> = {
  ...
  "swap.balance": "余额",
  "swap.max": "全部",
  "swap.sellReceiveHint": "你将在钱包内的 BNB 智能链地址收到 BNB。要出金的话，把这些 BNB 提到交易所再卖成法币即可。",
  ...
  "swap.stepLocked": "你的资金已锁定",
  "swap.stepMatched": "对手方已匹配",
  "swap.stepSettling": "结算并到账",
