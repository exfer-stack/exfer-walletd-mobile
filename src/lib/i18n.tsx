...
const EN = {
  ...
  "ix.info": "Resolves confirmed address history — the Activity feed and the From/To on each transfer. Leave both blank to use the bundled default.",
  "ix.urlLabel": "Indexer URL",
  "ix.urlHelp": "walletd reconnects on save.",
  "ix.tokenLabel": "Bearer token (optional)",
  "ix.tokenPlaceholder": "Leave blank for default",
...
const ZH: Record<MsgKey, string> = {
  ...
  "ix.info": "用于解析已确认的地址历史——即动态列表和每笔转账的来自/至。两项都留空则使用内置默认。",
  "ix.urlLabel": "索引器地址",
  "ix.urlHelp": "保存后 walletd 会重连。",
  "ix.tokenLabel": "Bearer 令牌（可选）",
  "ix.tokenPlaceholder": "留空则使用默认",
  "ix.updated": "索引器已更新",
