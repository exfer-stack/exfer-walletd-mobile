...
const EN = {
  ...
  "lp.progressHint": "Both legs are sent to the pool; your shares are credited once they confirm. You can close this — it finishes in the background.",
  ...
  "lp.belowMin": "Add at least ~{n} EXFER — below that the BNB leg can't cover the network fee, so the deposit is returned automatically.",
  ...
  "lp.refundedBody": "The deposit couldn't complete, so both legs were returned to your wallet.",
...
const ZH: Record<MsgKey, string> = {
  ...
  "lp.progressHint": "两条腿都已发往池子;到账确认后即记入份额。可以直接关闭——后台会继续完成。",
  ...
  "lp.belowMin": "至少投入约 {n} EXFER —— 再少 BNB 那条腿不够付网络费,会被自动退回。",
  ...
  "lp.refundedBody": "这笔没能完成,两条腿都已退回你的钱包。",
